...
import { MapPin, Briefcase, Calendar, ExternalLink, ChevronDown } from 'lucide-react';
...
function ExperienceCard({ experience }: { experience: ExperienceItem }) {
  ...
  const descriptionPreview = experience.description.split('.')[0] + '.';
